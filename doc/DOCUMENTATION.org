...
- [[#gui-elements][GUI Elements]]
  ...
  - [[#gui-toggles-1][GUI Toggles]]
    - [[#global-line-numbers-1][Global line numbers]]
...
- [[#layouts-and-workspaces][Layouts and workspaces]]
  ...
  - [[#compiling][Compiling]]
- [[#evil-plugins-1][Evil plugins]]
- [[#highlighted-features-1][Highlighted features]]
  - [[#update-packages-1][Update packages]]
      - [[#browsing-files-in-completion-buffer-1][Browsing files in completion buffer]]
- [[#concepts][Concepts]]
  - [[#editing-styles][Editing Styles]]
    - [[#emacs][Emacs]]
  - [[#searching-1][Searching]]
    - [[#with-an-external-tool-1][With an external tool]]
  - [[#states][States]]
  - [[#evilified-modes-1][Evilified modes]]
  - [[#evil-leader][Evil leader]]
      - [[#searching-in-files-in-an-arbitrary-directory][Searching in files in an arbitrary directory]]
- [[#differences-between-vim-evil-and-spacemacs-1][Differences between Vim, Evil and Spacemacs]]
  - [[#the-vim-surround-case-1][The vim-surround case]]
- [[#gui-elements-1][GUI Elements]]
      - [[#themes-transient-state][Themes Transient State]]
    - [[#browsing-themes][Browsing themes]]
    - [[#notes-1][Notes]]
  - [[#font][Font]]
      - [[#global-line-numbers-2][Global line numbers]]
  - [[#mode-line-1][Mode-line]]
      - [[#indent-text-object-1][Indent text object]]
      - [[#anzu-integration-1][Anzu integration]]
  ...
  - [[#layouts][Layouts]]
    ...
    - [[#custom-layouts][Custom Layouts]]
      - [[#lisp-key-bindings-1][Lisp Key bindings]]
    - [[#mouse-usage-1][Mouse usage]]
    - [[#layout-key-bindings-1][Layout key bindings]]
...
- [[#core-pillars-1][Core Pillars]]
  - [[#mnemonic-1][Mnemonic]]
  - [[#discoverable-1][Discoverable]]
  - [[#consistent-1][Consistent]]
  - [[#crowd-configured-1][Crowd-Configured]]
